...
faqs:
  - question: "¿Cuál es la diferencia entre automatización e IA?"
    ...
    answer: |
      ...
      No todas las empresas necesitan IA.
    ...
    answer_en: |
      ...
      Not all companies need AI.
      First order, then intelligence.

  - question: "¿Trabajáis con empresas pequeñas o solo grandes?"
  ...
  - question: "¿Trabajáis en remoto o presencial?"
    ...
    answer: |
      Trabajamos de forma híbrida.

      Las primeras reuniones suelen ser online por eficiencia,
      pero si el proyecto lo requiere y existe la oportunidad, realizamos visitas presenciales.
    answer_en: |
      We work in a hybrid way.

      The first meetings are usually online for efficiency,
      but if the project requires it and the opportunity exists, we make in-person visits.
  ...
  - question: "¿Cómo sé si esto encaja conmigo?"
    question_en: "How do I know if this fits me?"
    answer: |
      Muy sencillo:
